...
public class TestDeneme02SoftKonusu {
    WebDriver driver;
    ...
    public void testAssert() {
        ...
        WebElement allProductYaziElementi = driver.findElement(By.xpath("//*[text()='All Productss']"));
        softAssert.assertTrue(allProductYaziElementi.isDisplayed(), "All product sayfa testi");
        //6. The products list is visible
        List<WebElement> productList = driver.findElements(By.xpath("//*[text()='View Products']"));
        ...
        WebElement categoryElement = driver.findElement(By.xpath("//*[text()='Category: Women > Topss']"));
